...
export default function Home() {
  ...
  const [selectedMeetingForRecordings, setSelectedMeetingForRecordings] =
    useState<string | null>(null);
  const [activeTab, setActiveTab] = useState<"meetings" | "recordings">(
    "meetings"
  );
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  {meetings.map((meeting) => (
                    <div
                      key={meeting.id}
                      onClick={() =>
                        setSelectedMeetingForRecordings(meeting.id)
                      }
